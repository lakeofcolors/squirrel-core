...
use crate::handlers::store::{telegram_update_webhook, create_invoice, buy_item_for_nuts};
...
async fn main() {
    ...
    let router = Router::new()
        ...
        .route("/v1/clans/:id/chat", post(crate::handlers::clans::send_clan_message).get(crate::handlers::clans::get_clan_chat))
        .route("/v1/clans/:id/members/:target_id/role", post(crate::handlers::clans::change_member_role))
        .route("/v1/clans/:id/members/:target_id/kick", post(crate::handlers::clans::kick_member))
